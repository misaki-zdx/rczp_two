	...
	<script type="text/javascript" >
        function addSubmit(){
            ...
            $.ajax({
                type: "POST",
                url: "cv/addCv",
                data:"cid=&"+$('#addForm').serialize(), //将表单中的数据序列化
									...
									<div class="am-u-md-6">
										<form action=""  method="post" id="addForm">									    
										    <div class="am-form-group">
										    	<div class="am-g">
											      <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-email-1">用户ID</label>
											      <input class="am-u-md-10 form-control" name="uid"  id="doc-ipt-email-1" placeholder="输入用户ID">
											    </div>
										    </div>
										    
										    <div class="am-form-group">
										    	<div class="am-g">
											      <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-pwd-1">地址</label>
											      <input type="txt" class="am-u-md-10" name="cvPath" id="doc-ipt-pwd-1" placeholder="设置地址">
											    </div>
												</div>
...
<%-- 
	<!-- <span>简历id:</span>
	<input type="text" name="cid" placeholder="简历id">
	<br/> -->
	<span>用户id:</span>
	<input type="text" name="uid" placeholder="用户id">
	<br/>
	<span>简历地址:</span>
	<input type="text" name="cvPath" placeholder="简历地址">
	<br/>
