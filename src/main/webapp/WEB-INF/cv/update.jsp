								...
								<div class="am-u-md-6">
									<form action="" method="post" id="updateForm">
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0"
													for="doc-ipt-pwd-1">简历编号</label> <input class="am-u-md-10"
													name="cid"  value="${cv.cid}"
													id="doc-ipt-pwd-1" placeholder="设置简历编号">
											</div>
										</div>
										<div class="am-form-group">
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0"
													for="doc-ipt-email-1">用户编号</label> <input
													class="am-u-md-10 form-control" name="uid" 
													value="${cv.uid}" id="doc-ipt-email-1"
													placeholder="输入用户编号">
											</div> 
										</div>
										...
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0"
													for="doc-ipt-pwd-1">地址</label> <input type="cvPath"
													class="am-u-md-10" name="cvPath"
													value="${cv.cvPath}" id="doc-ipt-pwd-1"
													placeholder="设置地址">
											</div>
										</div>
...
<%-- <form action="" method="post" id="updateForm">
<div><span>简历id</span><span><input type="text" name="cid" value="${cvs.cid}" readonly="readonly"></span></div>
<div><span>用户id:</span><span><input type="text" name="uid" value="${cvs.uid}"></span></div>
<div><span>简历地址:</span><span><input type="text" name="cvPath" value="${cvs.cvPath}"></span></div>
