...
<script>
	...
	pageHelper = pageHelpers(url, function(data) {
		...
		for (var i = 0; i < data.length; i++) {
			...
			var tr = "<tr>" + "<td>" + data[i].cid + "</td>"
					+ "<td>" + data[i].uid + "</td>" + "<td>"
					+ data[i].cvPath + "</td>" + "<td><a href=''>详情</a></td>"
					+ "<td><a href='cv/showCid?cid=" + data[i].cid
					+ "'>修改</a></td>" + "<td><a href='cv/delete?cid="
					+ data[i].cid + "'>删除</a></td>"
					+ "</tr>";				
			trs += tr;
	...
	<body>
					...
					<div class="am-g">
						<div class="am-u-sm-12 am-u-md-6">
				          <div class="am-btn-toolbar">
				            ...
				            <span class="am-icon-plus"></span> <a href="cv/add">新增</a>
				            </button>  
				            </div>
				          </div>
				        </div>	
        ...
        <div class="am-u-sm-12">
            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
                <th class="table-id">简历ID</th>
                <th class="table-title">用户ID</th>
                <th class="table-date am-hide-sm-only">简历地址</th>
