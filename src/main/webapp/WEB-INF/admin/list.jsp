				...
				function(data) {
					...
					for (var i = 0; i < data.length; i++) {
						var tr = "<tr>" +
								...
								+ "			<span class='am-icon-pencil-square-o'></span> <a href='admin/getAdminAndUserByAid?aid="
								+ data[i].aid
								+ "'>详情</a>"
								+ "		</button>"
								+ "		<button"+
								"class='am-btn am-btn-default am-btn-xs am-hide-sm-only>"
								+ "			<span class='am-icon-copy'></span><a href='admin/showAid?aid="
								+ data[i].aid
								+ "'>修改"
								+ '</a>'
								+ "		</button>"
							...
							<div class="am-btn-toolbar">
								<div class="am-btn-group am-btn-group-xs">
									<button type="button" class="am-btn am-btn-default">
										<a href="admin/add"> <span class="am-icon-plus"></span> 新增
										</a>
									</button>
								</div>
							</div>
