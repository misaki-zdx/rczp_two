								...
								<div class="am-u-md-6">
									<form action="" method="post" id="updateForm">
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0"
													for="doc-ipt-pwd-1">管理员编号</label> <input class="am-u-md-10"
													name="aid" readonly="readonly" value="${admins.aid}"
													id="doc-ipt-pwd-1" placeholder="设置管理员密码">
											</div>
										</div>
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0"
													for="doc-ipt-email-1">姓名</label> <input
													class="am-u-md-10 form-control" name="aname"
													value="${admins.aname}" id="doc-ipt-email-1"
													placeholder="输入管理员姓名">
											</div>
										</div>
										...
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0"
													for="doc-ipt-pwd-1">密码</label> <input type="password"
													class="am-u-md-10" name="password"
													value="${admins.password}" id="doc-ipt-pwd-1"
													placeholder="设置管理员密码">
											</div>
										</div>
...
<%-- </div>
<form action="" method="post" id="updateForm">
<div><span>管理员编号</span><span><input type="text" name="aid" value="${admins.aid}" readonly="readonly"></span></div>
<div><span>管理员名称:</span><span><input type="text" name="aname" value="${admins.aname}"></span></div>
<div><span>管理员密码:</span><span><input type="text" name="password" value="${admins.password}"></span></div>
