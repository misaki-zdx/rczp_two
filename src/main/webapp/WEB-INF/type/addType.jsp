	...
	<script type="text/javascript" >
        function loginSubmit(){
            ...
            $.ajax({
                type: "POST",
                url: "Type/insertType",
                data:type= 'tid=&'+$('#loginForm').serialize(), //将表单中的数据序列化
									...
									<div class="am-u-md-6">
										<form action=""  method="post" id="addForm">									    
										    <div class="am-form-group">
										    	<div class="am-g">
											      <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-email-1">类型名</label>
											      <input class="am-u-md-10 form-control" name="typename"  id="doc-ipt-email-1" placeholder="类型名称">
											    </div>
										    </div>
												<button class="am-btn am-btn-secondary" type="button" onclick="loginSubmit()">添加</button>
										</form>
									</div>
