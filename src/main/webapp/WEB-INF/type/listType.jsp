	...
	var pageHelper;
        function loadView() {
           ...
           for (var i = 0; i < data.length; i++) {
                var tr = "<tr>" + "<td>" + data[i].tid + "</td>" 
                    + "<td>"+ data[i].typename + "</td>" + "<td><a href=''>详情</a></td>"
                    + "<td><a href='Type/showTid?tid=" + data[i].tid
                    + "'>修改</a></td>" 
                    + "<td><a href='Type/deleteType?tid=" + data[i].tid + "'>删除</a></td>"
                    + "</tr>";
                 trs += tr;
            }
            table.append(trs);
							...
							<div class="am-btn-toolbar">
								<div class="am-btn-group am-btn-group-xs">
									<button type="button" class="am-btn am-btn-default">
										<a href="Type/addType"> <span class="am-icon-plus"></span> 新增
										</a>
									</button>
								</div>
							</div>
