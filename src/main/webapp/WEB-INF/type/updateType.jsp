    ...
    <script type="text/javascript" >
        function updete(){
            ...
            $.ajax({
                type: "POST",
                url: "Type/updateType",
                data:types= $('#updateForm').serialize(), //将表单中的数据序列化
										...
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0"
													for="doc-ipt-pwd-1">类型编号</label> <input class="am-u-md-10"
													name="aid" readonly="readonly" value="${types.tid}"
													id="doc-ipt-pwd-1" placeholder="修改类型编号">
											</div>
										</div>
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0"
													for="doc-ipt-email-1">类型名称</label> <input
													class="am-u-md-10 form-control" name="aname"
													value="${types.typename}" id="doc-ipt-email-1"
													placeholder="修改类型名称">
											</div>
										</div>
