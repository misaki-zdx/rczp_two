...
<script>
	...
	function loadView() {
		...
		for (var i = 0; i < data.length; i++) {
			...
			var tr = "<tr>" 
				+ "<td>" + data[i].did + "</td>"
				+ "<td><a href='#'>" + data[i].uid + "</a></td>" 
				+ "<td>" + data[i].rid + "</td>" 
				+ "<td class='am-hide-sm-only'>" + data[i].passflag + "</td>"
				+ "<td class='am-hide-sm-only'>" + data[i].dtime + "</td>" 
				...
				+ "<a class='am-btn am-btn-default am-btn-xs am-hide-sm-only' href='deliverrecord/showAid?did=" + data[i].did + "'><span class='am-icon-copy'></span>修改</a></td>" 
				+ "<a class='am-btn am-btn-default am-btn-xs am-hide-sm-only' href='deliverrecord/delete?did="
				+ data[i].did + "'><span class='am-icon-trash-o'></span>删除</a></div></div></td>"
				+ "</tr>";
						...
						<div class="am-u-sm-12 am-u-md-6">
				          <div class="am-btn-toolbar">
				            <div class="am-btn-group am-btn-group-xs">
				              <a href='deliverrecord/add'><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
				            </div>
				          </div>
				        </div>	
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
                <!-- <th class="table-check"><input type="checkbox" /></th> --><th class="table-id">DId</th><th class="table-title">uid</th><th class="table-type">rid</th><th class="table-author am-hide-sm-only">passflag</th><th class="table-author am-hide-sm-only">dtime</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody id="table">
