...
<title>添加管理员</title>
	...
	<script type="text/javascript" >
        function addSubmit(){
            ...
            $.ajax({
                type: "POST",
                url: "/deliverrecord/addDeliverrecord",
                data:"did=&"+$('#addForm').serialize(), //将表单中的数据序列化
							...
							<div class="card-box">
								...
								<form action="" method="post" id="addForm" class="am-form" data-am-validator>
								    ...
								    <div class="am-form-group">
								      <label for="doc-vld-name-2">uid：</label>
								      <input type="text" name="uid" id="doc-vld-name-2" minlength="3" placeholder="uid" required/>
								    </div>
								
								    <div class="am-form-group">
								      <label for="doc-vld-email-2">rid：</label>
								      <input type="email" name="rid" id="doc-vld-email-2" placeholder="rid" required/>
								    </div>
								
								    <div class="am-form-group">
								      <label for="doc-vld-url-2">passflag：</label>
								      <input type="url" name="passflag" id="doc-vld-url-2" placeholder="PF" required/>
								    </div>
								    
								    <div class="am-form-group">
								      <label for="doc-vld-url-2">dtime：</label>
								      <input type="url" name="dtime" id="doc-vld-url-2" placeholder="时间" required/>
								    </div>
